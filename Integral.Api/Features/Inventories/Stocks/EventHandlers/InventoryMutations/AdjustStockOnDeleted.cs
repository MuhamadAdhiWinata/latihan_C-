...
public class AdjustStockOnDeleted(PrintingDbContext dbContext, CurrentUserProvider currentUser) : INotificationHandler<MutationDeleted>
{
    public async Task Handle(MutationDeleted notification, CancellationToken cancellationToken)
    {
